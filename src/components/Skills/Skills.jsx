...
const skills = [
    {
        title: 'HTML/CSS',
        content: 'flexbox, css composes, css comb, media queries, sass, css module'
    },
    {
        title: 'JAVASCRIPT',
        ...
        title: 'REACT',
        content: 'class and function components, life cycle methods, HOCs, hooks, local state, flux'
    }, {
        title: 'REDUX',
